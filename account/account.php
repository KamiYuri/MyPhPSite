<?php
    ...
    if(isset($_POST["search_account_btn"])){
        $user_id = $_POST["search_by_user_id"];
        $username = $_POST["search_by_username"];
                            ...
                            <form action="./account.php" method="post">
                                <div class="h-auto w-full flex flex-row items-center pt-4 space-x-8">
                                    ...
                                    <div class="flex w-auto items-center justify-start space-x-6">
                                        <label for="search_by_user_id" class="w-40">
                                            Tìm theo ID
                                        </label>
                                        <input name="search_by_user_id" id="search_by_user_id" type="number"
                                    ...
                                    <div class="flex w-full items-center space-x-3 justify-start space-x-4">
                                        ...
                                        <input name="search_by_username" id="search_by_username" type="text"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2">
                                    </div>
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        ...
                                                        echo ('
                                                            <div
                                                                class="w-24 flex flex-row py-0.5 justify-center rounded-md bg-').account_classify($row['type']).('-100">
                                                                <span
                                                                    class="text-xs leading-5 font-semibold text-').account_classify($row['type']).('-500 px-3 py-0.5">')
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="text-sm text-gray-500">
                                                            <?php
                                                                if($row["type"] == "0"){
                                                                    echo '<a href="./account_edit.php?id='.$row['id'].'">Chỉnh sửa</a> |'.
                                                                         '<a href="./account_disable.php?id='.$row['id'].'" onclick='.'"return confirm(\'Chắc chắn muốn vô hiệu hóa tài khoản này?\');"> Vô hiệu hóa</a>';
                                                                }
                                                            ?>
                                                        </div>
                                                    </td>
