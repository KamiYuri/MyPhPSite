                            ...
                            <div class="w-full items-center divide-gray-300 divide-y divide-solid">
                                <div
                                    ...
                                    <input name="title" id="title" type="text"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2 w-full" required value="<?php echo $row["title"] ?>">
